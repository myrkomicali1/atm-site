...
export const metadata: Metadata = {
  ...
  description:
    "A Authomathika atende 12 setores industriais: sucroenergético, fertilizantes, energias renováveis, saneamento, alimentos, siderurgia, logística, papel e celulose, cimento, petróleo e gás e infraestrutura.",
  alternates: {
    canonical: "/setores",
  },
};
