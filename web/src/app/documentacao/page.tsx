...
export const metadata: Metadata = {
  ...
  description:
    "Certificacoes, indicadores de seguranca, dados cadastrais e materiais tecnicos da Authomathika. ISO 9001, NR-10, NR-35, RBC.",
  alternates: {
...
const certifications = [
  {
    name: "ISO 9001",
    description: "Sistema de gestao da qualidade certificado, garantindo processos padronizados e melhoria continua em todos os projetos.",
    icon: Award,
    status: "Vigente",
  },
  {
...
const safetyIndicators = [
  { value: "2.000+", label: "Dias sem acidentes de trabalho", description: "Marca alcancada em 2019 e mantida como padrao operacional" },
  { value: "0", label: "TFCA (Taxa de Frequencia de Acidentes)", description: "Compromisso zero acidentes em todas as frentes de trabalho" },
...
const technicalMaterials = [
  ...
  { title: "Certificado ISO 9001", description: "Certificado vigente do sistema de gestao da qualidade.", format: "PDF", available: false },
          ...
          <Panel className="max-w-2xl">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-zinc-900">{company.erp}</p>
              </div>
            </div>
          </Panel>
        </Container>
