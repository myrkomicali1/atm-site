...
export const metadata: Metadata = {
  title: "Nossa Equipe",
  description:
    "Conhega a lideranga da Authomathika. Mais de 25 anos de experiencia em engenharia integradora de sistemas eletricos e automacao.",
  alternates: {
  ...
  return (
    <main>
      <PageIntro
        tag="Pessoas"
        title="Nossa Equipe"
        subtitle="Por tras de cada projeto entregue, existe uma equipe comprometida com excelencia tecnica e seguranca."
        breadcrumbs={[
          ...
          <Panel className="overflow-hidden">
            <div className="grid gap-8 md:grid-cols-[200px_1fr] md:items-start">
              ...
              <div className="space-y-4">
                <Eyebrow>Mensagem da Presidencia</Eyebrow>
      ...
      <Section className="bg-zinc-50">
        <Container>
          <div className="mb-12 max-w-2xl">
            <Eyebrow>Lideranca</Eyebrow>
            <h2 className="section-heading-sm mt-4 text-zinc-900">
              Equipe de gestao
            </h2>
            <p className="mt-3 text-base text-zinc-600">
              Profissionais com decadas de experiencia nos setores sucroenergetico, mineracao, energia e infraestrutura.
            </p>
          </div>
