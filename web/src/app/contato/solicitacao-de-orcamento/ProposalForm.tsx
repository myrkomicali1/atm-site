...
const projectTypes = [
  ...
  "Brownfield (ampliacao/modernizacao)",
  "Revamp (retrofit)",
  "Manutencao / Parada programada",
  "Outro",
];

const serviceOptions = [
  { id: "automacao", label: "Automacao Industrial" },
  { id: "eletrica", label: "Engenharia Eletrica" },
  { id: "energias-renovaveis", label: "Energias Renovaveis" },
  { id: "montagem", label: "Montagem Eletromecanica" },
  { id: "epc", label: "Engenharia EPC" },
  { id: "servicos", label: "Servicos e Manutencao" },
];
