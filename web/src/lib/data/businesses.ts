...
export const businessAreas: BusinessArea[] = [
  ...
  },
  {
    ...
    description:
      "A divisão de IA & Dados é operada pela doubleX e NovaIA, empresas do grupo, que aplicam inteligência artificial, automação de processos e análise de dados para transformar a gestão de empresas. Atuamos na otimização de rotinas administrativas, gestão financeira, controle de estoque, planejamento de recursos, atendimento ao cliente e inteligência comercial. Ajudamos empresas de qualquer segmento a tomar decisões mais rápidas e fundamentadas em dados — da diretoria ao operacional.",
    services: [
